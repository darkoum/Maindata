...
export class PrgexportqueryComponent implements OnInit {
  ...
  ngOnInit(): void {
   // this.getRootyp();
    ...
    // Mock data สำหรับทดสอบบน localhost
  ...
  loadMockData(): void {
    this.querylist = [
      { รหัสนักศึกษา: '6401001', ชื่อ: 'สมชาย', นามสกุล: 'ใจดี',       คณะ: 'วิศวกรรมศาสตร์',  สาขา: 'วิศวกรรมคอมพิวเตอร์', ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'กำลังศึกษา' },
      { รหัสนักศึกษา: '6401002', ชื่อ: 'สมหญิง', นามสกุล: 'รักเรียน',   คณะ: 'บริหารธุรกิจ',    สาขา: 'การบัญชี',             ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'กำลังศึกษา' },
      { รหัสนักศึกษา: '6401003', ชื่อ: 'วิชัย', นามสกุล: 'มุ่งมั่น',     คณะ: 'วิทยาศาสตร์',    สาขา: 'เทคโนโลยีสารสนเทศ',   ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'กำลังศึกษา' },
      { รหัสนักศึกษา: '6401004', ชื่อ: 'อรอุมา', นามสกุล: 'พัฒนา',      คณะ: 'ครุศาสตร์',       สาขา: 'การศึกษาปฐมวัย',      ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'ลาพัก'    },
      { รหัสนักศึกษา: '6401005', ชื่อ: 'ธนากร', นามสกุล: 'สุขสันต์',    คณะ: 'วิศวกรรมศาสตร์',  สาขา: 'วิศวกรรมไฟฟ้า',       ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'กำลังศึกษา' },
      { รหัสนักศึกษา: '6501001', ชื่อ: 'พิมพ์ใจ', นามสกุล: 'ดวงดี',     คณะ: 'แพทยศาสตร์',     สาขา: 'แพทย์ทั่วไป',          ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'กำลังศึกษา' },
      { รหัสนักศึกษา: '6501002', ชื่อ: 'ก้องเกียรติ', นามสกุล: 'ศรีสุข', คณะ: 'นิติศาสตร์',      สาขา: 'นิติศาสตร์',           ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'สำเร็จการศึกษา' },
      { รหัสนักศึกษา: '6501003', ชื่อ: 'นภาพร', นามสกุล: 'แสงสว่าง',   คณะ: 'บริหารธุรกิจ',    สาขา: 'การตลาด',              ระดับ: 'ปริญญาโท',  ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'กำลังศึกษา' },
      { รหัสนักศึกษา: '6501004', ชื่อ: 'ชัยวัฒน์', นามสกุล: 'เจริญ',    คณะ: 'วิทยาศาสตร์',    สาขา: 'ฟิสิกส์',              ระดับ: 'ปริญญาเอก', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'กำลังศึกษา' },
      { รหัสนักศึกษา: '6501005', ชื่อ: 'มาลี', นามสกุล: 'วงศ์งาม',     คณะ: 'ครุศาสตร์',       สาขา: 'ภาษาไทย',             ระดับ: 'ปริญญาตรี', ปีการศึกษา: 2567, เทอม: 1, สถานะ: 'พ้นสภาพ'  },
    ];
  }
