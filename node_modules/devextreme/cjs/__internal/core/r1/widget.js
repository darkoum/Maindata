...
class Widget extends _index.InfernoWrapperComponent {
    ...
    updateEffects() {
        ...
        null === (_this$_effects$0 = this._effects[10]) || void 0 === _this$_effects$0 || _this$_effects$0.update([this.props.onDimensionChanged]);
        null === (_this$_effects$1 = this._effects[11]) || void 0 === _this$_effects$1 || _this$_effects$1.update([this.props.name, this.props.onVisibilityChange]);
        null === (_this$_effects$10 = this._effects[12]) || void 0 === _this$_effects$10 || _this$_effects$10.update([this.props.height, this.props.width]);
        null === (_this$_effects$11 = this._effects[13]) || void 0 === _this$_effects$11 || _this$_effects$11.update([this.props.cssText])
    }
    setRootElementRef() {
    ...
    keyboardEffect() {
        ...
        if (focusStateEnabled && onKeyDown) {
            ...
            const id = _short.keyboard.on(null === (_this$widgetElementRe0 = this.widgetElementRef) || void 0 === _this$widgetElementRe0 ? void 0 : _this$widgetElementRe0.current, null === (_this$widgetElementRe1 = this.widgetElementRef) || void 0 === _this$widgetElementRe1 ? void 0 : _this$widgetElementRe1.current, e => onKeyDown(e));
    ...
    resizeEffect() {
        ...
        if (onDimensionChanged) {
            ...
            _short.resize.on(null === (_this$widgetElementRe10 = this.widgetElementRef) || void 0 === _this$widgetElementRe10 ? void 0 : _this$widgetElementRe10.current, onDimensionChanged, {
                namespace: namespace
            });
            return () => {
                var _this$widgetElementRe11;
                return _short.resize.off(null === (_this$widgetElementRe11 = this.widgetElementRef) || void 0 === _this$widgetElementRe11 ? void 0 : _this$widgetElementRe11.current, {
                    namespace: namespace
                })
            }
        }
    ...
    visibilityEffect() {
        ...
        if (onVisibilityChange) {
            ...
            _short.visibility.on(null === (_this$widgetElementRe12 = this.widgetElementRef) || void 0 === _this$widgetElementRe12 ? void 0 : _this$widgetElementRe12.current, () => onVisibilityChange(true), () => onVisibilityChange(false), {
                namespace: namespace
            });
            return () => {
                var _this$widgetElementRe13;
                return _short.visibility.off(null === (_this$widgetElementRe13 = this.widgetElementRef) || void 0 === _this$widgetElementRe13 ? void 0 : _this$widgetElementRe13.current, {
                    namespace: namespace
                })
            }
        }
    ...
    applyCssTextEffect() {
        ...
        if (void 0 !== cssText && "" !== cssText && null !== (_this$widgetElementRe14 = this.widgetElementRef) && void 0 !== _this$widgetElementRe14 && _this$widgetElementRe14.current) {
    ...
    focus() {
        ...
        _short.focus.trigger(null === (_this$widgetElementRe15 = this.widgetElementRef) || void 0 === _this$widgetElementRe15 ? void 0 : _this$widgetElementRe15.current)
    }
    blur() {
        var _this$widgetElementRe16, _this$widgetElementRe17;
        const activeElement = _dom_adapter.default.getActiveElement(null === (_this$widgetElementRe16 = this.widgetElementRef) || void 0 === _this$widgetElementRe16 ? void 0 : _this$widgetElementRe16.current);
        if ((null === (_this$widgetElementRe17 = this.widgetElementRef) || void 0 === _this$widgetElementRe17 ? void 0 : _this$widgetElementRe17.current) === activeElement) {
            activeElement.blur()
        }
    }
    activate() {
