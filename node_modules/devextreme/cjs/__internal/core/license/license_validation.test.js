...
(0, _globals.describe)("license check", () => {
    ...
    let consoleWarnSpy = _globals.jest.spyOn(console, "warn");
    (0, _globals.beforeEach)(() => {
        _globals.jest.spyOn(_errors.default, "log").mockImplementation(() => {});
        consoleWarnSpy = _globals.jest.spyOn(console, "warn").mockImplementation(() => {});
    ...
    _globals.test.each([{
        ...
        token: _const.LICENSE_KEY_PLACEHOLDER,
        version: "1.0.3"
        ...
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledTimes(2);
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledWith(_globals.expect.stringContaining("devextreme-license generated key has not been specified"))
    });
    _globals.test.each([{
        token: "",
        version: "1.0.3"
    ...
    _globals.test.each([{
        ...
        (0, _license_validation.validateLicense)(token, version);
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledTimes(2);
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledWith(_globals.expect.stringContaining("Incompatible DevExpress license key version"))
    });
    _globals.test.each([{
        token: TOKEN_23_1,
        version: "23.2.3"
    ...
    _globals.test.each([{
        ...
        (0, _license_validation.validateLicense)(token, version);
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledTimes(2);
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledWith(_globals.expect.stringContaining("License key verification has failed"))
    });
    _globals.test.each([{
        token: TOKEN_UNVERIFIED,
        version: "1.2.3"
...
(0, _globals.describe)("DevExpress license check", () => {
    ...
    (0, _globals.test)("DevExpress License Key copied from Download Manager (incorrect)", () => {
        ...
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledTimes(2);
        (0, _globals.expect)(consoleWarnSpy).toHaveBeenCalledWith(_globals.expect.stringContaining("DevExpress license key has been specified instead of a key generated using devextreme-license"));
