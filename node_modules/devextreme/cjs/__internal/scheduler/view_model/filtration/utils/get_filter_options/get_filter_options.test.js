...
var _get_compare_options = require("../../../../../scheduler/view_model/common/get_compare_options");
...
(0, _globals.describe)("getFilterOptions", () => {
    ["agenda", "month"].forEach(type => {
        (0, _globals.it)(`should return correct filter options for ${type} view`, () => {
            ...
            const filterOptions = (0, _get_filter_options.getFilterOptions)(schedulerStore, compareOptions);
            (0, _globals.expect)(filterOptions).toEqual({
                allDayPanelMode: "allDay",
                showAllDayPanel: true,
