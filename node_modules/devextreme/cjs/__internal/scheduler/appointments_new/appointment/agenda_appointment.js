/**
 * DevExtreme (cjs/__internal/scheduler/appointments_new/appointment/agenda_appointment.js)
 * Version: 25.2.7
...
var _base_appointment = require("./base_appointment");
...
class AgendaAppointmentView extends _base_appointment.BaseAppointmentView {
    ...
    renderMarker($container) {
        const $leftContainer = (0, _renderer.default)("<div>").addClass(_const.AGENDA_APPOINTMENT_CLASSES.LEFT_LAYOUT).appendTo($container);
    ...
    renderInfo($container) {
        const $rightContainer = (0, _renderer.default)("<div>").addClass(_const.AGENDA_APPOINTMENT_CLASSES.RIGHT_LAYOUT).appendTo($container);
