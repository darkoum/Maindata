...
(0, _globals.describe)("Appointments", () => {
    ...
    (0, _globals.describe)("Focus and keyboard navigation", () => {
        ...
        (0, _globals.describe)("Navigation after partial render", () => {
            ...
            (0, _globals.it)("should navigate to the last appointment correctly after an appointment is added", () => {
                ...
                viewModel = [(0, _appointment_view_model.mockGridViewModel)(dataA, {
                    sortedIndex: 0
                }), (0, _appointment_view_model.mockGridViewModel)(dataB, {
                    sortedIndex: 1
                }), (0, _appointment_view_model.mockGridViewModel)(dataNEW, {
                ...
                (0, _globals.expect)(document.activeElement).toBe(null === lastViewItem || void 0 === lastViewItem ? void 0 : lastViewItem.$element().get(0));
                (0, _globals.expect)(null === lastViewItem || void 0 === lastViewItem ? void 0 : lastViewItem.$element().attr("tabindex")).toBe("0")
            });
            (0, _globals.it)("should navigate to the last appointment correctly after an appointment is removed", () => {
            ...
            (0, _globals.it)("should navigate to the last appointment correctly after an appointment is updated", () => {
                ...
                instance.option("viewModel", viewModel);
                (null === (_instance$getViewItem37 = instance.getViewItemBySortedIndex(0)) || void 0 === _instance$getViewItem37 ? void 0 : _instance$getViewItem37.$element().get(0)).click();
                pressTab();
                pressTab();
    ...
    (0, _globals.describe)("onAppointmentRendered", () => {
        (0, _globals.it)("should be called with correct arguments when grid appointment is rendered", () => {
            const onAppointmentRendered = _globals.jest.fn();
            const instance = createAppointments(Object.assign({}, getProperties(), {
            ...
            (0, _globals.expect)(onAppointmentRendered).toHaveBeenCalledTimes(1);
            (0, _globals.expect)(onAppointmentRendered).toHaveBeenCalledWith(_globals.expect.objectContaining({
                appointmentData: defaultAppointmentData,
                targetedAppointmentData: _globals.expect.objectContaining({
                    text: defaultAppointmentData.text
                })
            }))
        });
        (0, _globals.it)("should be called with correct arguments when agenda appointment is rendered", () => {
            const onAppointmentRendered = _globals.jest.fn();
            const instance = createAppointments(Object.assign({}, getProperties(), {
                onAppointmentRendered: onAppointmentRendered
            }));
        ...
        (0, _globals.it)("should not be called when appointment collector is rendered", () => {
            const onAppointmentRendered = _globals.jest.fn();
            const instance = createAppointments(Object.assign({}, getProperties(), {
                onAppointmentRendered: onAppointmentRendered
            }));
            ...
            (0, _globals.expect)(onAppointmentRendered).not.toHaveBeenCalled()
        });
        (0, _globals.it)("should be called several times when several appointments are rendered", () => {
            const onAppointmentRendered = _globals.jest.fn();
            const instance = createAppointments(Object.assign({}, getProperties(), {
                onAppointmentRendered: onAppointmentRendered
            }));
            ...
            (0, _globals.expect)(onAppointmentRendered).toHaveBeenCalledTimes(2);
            (0, _globals.expect)(onAppointmentRendered).toHaveBeenNthCalledWith(1, _globals.expect.objectContaining({
                appointmentData: _globals.expect.objectContaining({
                    text: "Appointment 1"
                })
            }));
            (0, _globals.expect)(onAppointmentRendered).toHaveBeenNthCalledWith(2, _globals.expect.objectContaining({
                appointmentData: _globals.expect.objectContaining({
                    text: "Appointment 2"
                })
            }))
