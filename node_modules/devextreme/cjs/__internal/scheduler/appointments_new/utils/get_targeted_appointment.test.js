/**
 * DevExtreme (cjs/__internal/scheduler/appointments_new/utils/get_targeted_appointment.test.js)
 * Version: 25.2.7
...
(0, _globals.describe)("getTargetedAppointment", () => {
    (0, _globals.it)("should return grid item targeted appointment", () => {
        (0, _globals.expect)((0, _get_targeted_appointment.getTargetedAppointment)({
            itemData: recurringAppointment,
            info: info,
            groupIndex: 0
        }, _appointment_data_accessor.mockAppointmentDataAccessor, (0, _resource_manager.getResourceManagerMock)([]))).toEqual(Object.assign({}, recurringAppointment, {
            startDate: new Date(200, 0, 5),
            endDate: new Date(200, 0, 6),
    ...
    (0, _globals.it)("should return grid item targeted appointment with resources", async () => {
        ...
        (0, _globals.expect)((0, _get_targeted_appointment.getTargetedAppointment)({
            ...
            info: info,
            groupIndex: 5
        }, _appointment_data_accessor.mockAppointmentDataAccessor, resourceManager)).toEqual(Object.assign({}, recurringAppointment, {
            assigneeId: [2],
            roomId: 1,
            startDate: new Date(200, 0, 5),
            endDate: new Date(200, 0, 6),
    ...
    (0, _globals.it)("should return agenda item targeted partial dates with resources", async () => {
        ...
        (0, _globals.expect)((0, _get_targeted_appointment.getTargetedAppointment)({
            ...
            groupIndex: 3
        }, _appointment_data_accessor.mockAppointmentDataAccessor, resourceManager)).toEqual(Object.assign({}, appointment, {
            assigneeId: [4],
            roomId: 0,
            startDate: new Date(200, 0, 5),
            endDate: new Date(200, 0, 6),
