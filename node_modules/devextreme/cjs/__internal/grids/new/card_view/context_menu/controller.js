...
class ContextMenuController extends _controller.BaseContextMenuController {
    ...
    getSortingItems(column) {
        ...
        return [{
            text: this.options.oneWay("sorting.ascendingText").peek() ?? _message.default.format("dxDataGrid-sortingAscendingText"),
            value: "asc",
            disabled: isDisabled || "asc" === column.sortOrder,
            icon: "sortuptext",
            onItemClick: onItemClick
        }, {
            text: this.options.oneWay("sorting.descendingText").peek() ?? _message.default.format("dxDataGrid-sortingDescendingText"),
            value: "desc",
            disabled: isDisabled || "desc" === column.sortOrder,
            icon: "sortdowntext",
            onItemClick: onItemClick
        }, {
            text: this.options.oneWay("sorting.clearText").peek() ?? _message.default.format("dxDataGrid-sortingClearText"),
            value: void 0,
