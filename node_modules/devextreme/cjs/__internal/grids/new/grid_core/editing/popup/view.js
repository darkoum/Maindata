...
class EditPopupView extends _view.View {
    constructor(options, columnsController, itemsController, editingController, toolbar, kbn) {
        ...
        this.editingTexts = (0, _index.computed)(() => {
            const texts = this.editingController.texts.value;
            return {
                confirmDeleteMessage: texts.confirmDeleteMessage ?? _message.default.format("dxDataGrid-editingConfirmDeleteMessage"),
                confirmDeleteTitle: texts.confirmDeleteTitle ?? "",
                deleteCard: texts.deleteCard ?? _message.default.format("dxDataGrid-editingDeleteRow"),
                editCard: texts.editCard ?? _message.default.format("dxDataGrid-editingEditRow"),
                saveCard: texts.saveCard ?? _message.default.format("dxDataGrid-editingSaveRowChanges"),
                addCard: texts.addCard ?? _message.default.format("dxDataGrid-editingAddRow"),
                cancel: texts.cancel ?? _message.default.format("dxDataGrid-editingCancelRowChanges")
            }
        });
