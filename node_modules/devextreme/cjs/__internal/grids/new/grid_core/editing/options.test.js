...
(0, _globals.describe)("Options", () => {
    (0, _globals.describe)("editing", () => {
        ...
        (0, _globals.describe)("allowUpdating", () => {
            (0, _globals.it)('should add "edit" button to card', () => {
                setupCardView({
                    columns: [{
                        dataField: "field1"
                    }, "id"],
                ...
                (0, _globals.expect)(null === card || void 0 === card ? void 0 : card.innerHTML).toContain('aria-label="edit"')
            })
        });
        (0, _globals.describe)("allowRemoving", () => {
            (0, _globals.it)('should add "remove" button to card', () => {
                ...
                (0, _inferno.rerender)();
                const card = rootQuerySelector(SELECTORS.card);
                (0, _globals.expect)(null === card || void 0 === card ? void 0 : card.innerHTML).toContain('aria-label="trash"')
            })
        });
