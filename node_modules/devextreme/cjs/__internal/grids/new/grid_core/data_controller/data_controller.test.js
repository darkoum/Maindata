...
(0, _globals.describe)("DataController", () => {
    ...
    (0, _globals.describe)("regressions", () => {
        (0, _globals.it)("should work good with odata store", async () => {
            const sendRequestSpy = _globals.jest.spyOn(_ajax.default, "sendRequest").mockImplementation(params => {
                const isFirstPage = void 0 === params.data.$skip || 0 === params.data.$skip;
                const response = {
                    d: {
                        results: isFirstPage ? [{
                            Product_ID: 1
            ...
            (0, _globals.expect)(sendRequestSpy).toHaveBeenLastCalledWith(_globals.expect.objectContaining({
                data: _globals.expect.objectContaining({
                    $top: 3,
                    $filter: "Product_Current_Inventory gt 0",
