...
class KeyboardNavigationController extends _m_modules.default.ViewController {
    ...
    _getFixedColumnIndexOffset(column) {
        const visibleColumnCount = this._columnsController.getVisibleColumns(null, true).length;
        const offset = (0, _utils.isFixedColumnIndexOffsetRequired)(this, column) ? visibleColumnCount - this._columnsController.getVisibleColumns().length : 0;
        return offset
    }
    ...
    _getCellPosition($cell, direction) {
        const $row = (0, _utils.isElementDefined)($cell) && $cell.closest("tr");
        if ((0, _utils.isElementDefined)($row)) {
