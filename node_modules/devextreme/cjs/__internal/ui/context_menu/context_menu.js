...
class ContextMenu extends _menu_base.default {
    ...
    _renderItems(nodes, submenuContainer) {
        ...
        const $submenu = (0, _renderer.default)(null === (_this$_overlay0 = this._overlay) || void 0 === _this$_overlay0 ? void 0 : _this$_overlay0.content()).children(".dx-submenu");
        if ($submenu.length) {
            this._initScrollable($submenu)
        }
    }
    _setAriaAttributes() {
        ...
        this.setAria({
            ...
            role: "menu"
        }, null === (_this$_overlay1 = this._overlay) || void 0 === _this$_overlay1 ? void 0 : _this$_overlay1.$content())
    }
