...
class Popup extends _overlay.default {
    ...
    _renderTopToolbarImpl() {
        ...
        const $toolbarContainer = (0, _renderer.default)("<div>").addClass("dx-popup-title").insertBefore($content);
    ...
    _renderBottomToolbarImpl() {
        ...
        const $toolbarContainer = (0, _renderer.default)("<div>").addClass("dx-popup-bottom").insertAfter($content);
