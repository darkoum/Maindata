/**
 * DevExtreme (cjs/__internal/ui/date_box/date_box.mask.js)
 * Version: 25.2.7
...
var _date_box = _interopRequireDefault(require("./date_box.base"));
var _date_boxMask = require("./date_box.mask.parts");
...
const FORWARD = 1;
const BACKWARD = -1;
class DateBoxMask extends _date_box.default {
    _supportedKeys() {
    ...
    _shouldUseOriginalHandler(e) {
        ...
        const isNotDeletingInCalendar = opened && e && !["backspace", "del"].includes((0, _index.normalizeKeyName)(e) ?? "");
    ...
    _toggleAmPm() {
        ...
        const periodNames = _date3.default.getPeriodNames(this._formatPattern);
    ...
    _useBeforeInputEvent() {
        return Boolean(_devices.default.real().android)
    }
    _keyInputHandler(e, key) {
        ...
        if (isValueChanged) {
            _events_engine.default.triggerHandler(this._input(), {
                type: "input"
            })
        }
    }
    _keyboardHandler(e) {
        ...
        if (_browser.default.chrome && "Process" === e.key && e.code.startsWith("Digit")) {
    ...
    _renderDateParts() {
        ...
        if (newText) {
            this._dateParts = (0, _date_boxMask.renderDateParts)(newText, this._regExpInfo);
    ...
    _selectNextPart() {
        ...
        let index = (0, _math.fitIntoRange)(activePartIndex + step, 0, this._dateParts.length - 1);
    ...
    _getActivePartValue(dateValue) {
        ...
        const isGetterFunction = (0, _type.isFunction)(getter);
    ...
    _setActivePartValue(value, dateValue) {
        ...
        const limits = this._getActivePartLimits();
        newValue = (0, _math.inRange)(newValue, limits.min, limits.max) ? newValue : newValue % 10;
        newValue = this._addLeadingZeroes((0, _math.fitIntoRange)(newValue, limits.min, limits.max));
        if ((0, _type.isFunction)(setter)) {
    ...
    _maskClickHandler() {
        ...
        if (text) {
            var _this$_caret;
            this._activePartIndex = (0, _date_boxMask.getDatePartIndexByPosition)(this._dateParts, (null === (_this$_caret = this._caret()) || void 0 === _this$_caret ? void 0 : _this$_caret.start) ?? 0);
            if (!this._isAllSelected()) {
                this._clearSearchValue();
                if ((0, _type.isDefined)(this._activePartIndex)) {
                    this._caret(this._getActivePartProp("caret"))
    ...
    _maskPasteHandler(e) {
        ...
        const newText = this._replaceSelectedText(text, this._caret(), (0, _dom.clipboardText)(e));
    ...
    _isDateValid(date) {
        return (0, _type.isDate)(date) && !isNaN(date.getTime())
    }
    _isValueDirty() {
