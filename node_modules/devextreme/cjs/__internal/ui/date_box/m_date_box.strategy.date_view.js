...
class DateViewStrategy extends _m_date_box.default {
    ...
    getDisplayFormat(displayFormat) {
        return displayFormat || _date_utils.default.FORMATS_MAP[this.dateBox.option("type")]
    }
    popupConfig(config) {
        return {
    ...
    _getWidgetOptions() {
        return {
            ...
            maxDate: this.dateBox.getDateOption("max") || new Date(Date.now() + 50 * _date_utils.default.ONE_YEAR),
