...
class NativeStrategy extends _m_date_box.default {
    ...
    getParsedText(text) {
        ...
        return _date_utils.default.fromStandardDateFormat(text)
    }
    renderPopupContent() {}
    _getWidgetName() {}
    _getWidgetOptions() {}
    _getDateBoxType() {
        ...
        if (!_date_utils.default.SUPPORTED_FORMATS.includes(type)) {
            type = "date"
    ...
    getDisplayFormat(displayFormat) {
        ...
        return displayFormat || _date_utils.default.FORMATS_MAP[type]
    }
    renderInputMinMax($input) {
        ...
        $input.attr({
            min: _date_serialization.default.serializeDate(this.dateBox.getDateOption("min"), format),
            max: _date_serialization.default.serializeDate(this.dateBox.getDateOption("max"), format)
        })
    }
}
