/**
 * DevExtreme (cjs/__internal/ui/date_box/date_view_roller.js)
 * Version: 25.2.7
...
class DateViewRoller extends _scrollable.default {
    ...
    _renderWheelEvent() {
        _events_engine.default.on((0, _renderer.default)(this.container()), "dxmousewheel", () => {
    ...
    _renderSelectedValue(selectedIndex) {
        const {
            selectedIndex: oldSelectedIndex = 0
        } = this.option();
    ...
    _renderActiveStateItem() {
        ...
        this._$items.each((index, element) => {
            (0, _renderer.default)(element).toggleClass("dx-dateview-item-selected", selectedIndex === index);
            return true
        })
    }
    _shouldScrollToNeighborItem() {
        return Boolean("desktop" === _devices.default.real().deviceType && this._isWheelScrolled)
    }
    _moveTo(targetLocation) {
        ...
        if (this._isVisible() && (delta.x || delta.y)) {
            ...
            if (this._animation && !this._shouldScrollToNeighborItem()) {
                _animation.fx.stop((0, _renderer.default)(this.content()).get(0), false);
                _animation.fx.animate((0, _renderer.default)(this.content()).get(0), {
                    duration: 200,
                    type: "slide",
                    to: {
                    ...
                    complete: () => {
                        (0, _translator.resetPosition)((0, _renderer.default)(this.content()));
                        this.handleMove({
                            delta: delta
                        })
                    }
    ...
    _endActionHandler() {
        const {
            selectedIndex: currentSelectedIndex = 0
        } = this.option();
