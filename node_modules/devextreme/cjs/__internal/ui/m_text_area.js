...
class TextArea extends _m_text_box.default {
    ...
    _getHeightDifference($input) {
        ...
        const verticalEditorContainerOffset = (0, _size.getVerticalOffsets)(null === (_this$_$textEditorCon = this._$textEditorContainer) || void 0 === _this$_$textEditorCon ? void 0 : _this$_$textEditorCon.get(0), false);
        const verticalInputContainerOffsets = (0, _size.getVerticalOffsets)(null === (_this$_$textEditorInp = this._$textEditorInputContainer) || void 0 === _this$_$textEditorInp ? void 0 : _this$_$textEditorInp.get(0), true);
    ...
    _updateInputAutoResizeAppearance($input, isAutoResizeEnabled) {
        if ($input) {
            const autoResizeEnabled = (0, _common.ensureDefined)(isAutoResizeEnabled, Boolean(this.option("autoResizeEnabled")));
