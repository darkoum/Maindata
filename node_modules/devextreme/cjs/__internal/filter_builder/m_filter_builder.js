...
class FilterBuilder extends _ui3.default {
    ...
    _getGroupOperations(criteria) {
        ...
        const groupOperationDescriptions = {
            and: this.option("groupOperationDescriptions.and") ?? _message.default.format("dxFilterBuilder-and"),
            or: this.option("groupOperationDescriptions.or") ?? _message.default.format("dxFilterBuilder-or"),
            notAnd: this.option("groupOperationDescriptions.notAnd") ?? _message.default.format("dxFilterBuilder-notAnd"),
            notOr: this.option("groupOperationDescriptions.notOr") ?? _message.default.format("dxFilterBuilder-notOr")
        };
