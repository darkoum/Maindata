...
class FileManagerThumbnailsItemList extends FileManagerItemListBase {
    ...
    _selectItemSingleSelection(item) {
        if (item) {
            ...
            null === (_this$_itemList0 = this._itemList) || void 0 === _this$_itemList0 || _this$_itemList0.selectItem(item)
        } else {
            var _this$_itemList1;
            null === (_this$_itemList1 = this._itemList) || void 0 === _this$_itemList1 || _this$_itemList1.clearSelection()
        }
    }
    clearSelection() {
        var _this$_itemList10;
        null === (_this$_itemList10 = this._itemList) || void 0 === _this$_itemList10 || _this$_itemList10.clearSelection()
    }
    getSelectedItems() {
        var _this$_itemList11;
        return null === (_this$_itemList11 = this._itemList) || void 0 === _this$_itemList11 ? void 0 : _this$_itemList11.getSelectedItems()
    }
}
