...
export class FileItemsController {
    ...
    downloadItems(itemInfos) {
        ...
        return when(...deferreds).then(() => {
            ...
            return when(this._getItemActionResult(null === (_this$_fileProvider0 = this._fileProvider) || void 0 === _this$_fileProvider0 ? void 0 : _this$_fileProvider0.downloadItems(items))).then(() => {}, errorInfo => {
    ...
    getItemContent(itemInfos) {
        ...
        const items = itemInfos.map(i => i.fileItem);
        return when(null === (_this$_fileProvider1 = this._fileProvider) || void 0 === _this$_fileProvider1 ? void 0 : _this$_fileProvider1.getItemsContent(items))
    }
