/**
 * DevExtreme (esm/__internal/scheduler/appointment_popup/appointment_popup.integration.test.js)
 * Version: 25.2.7
...
describe("Appointment Form", () => {
    ...
    describe("Recurrence Form", () => {
        ...
        it("should close repeat selectbox popup when navigating to recurrence group via settings button", async () => {
            ...
            expect(null === repeatEditor || void 0 === repeatEditor ? void 0 : repeatEditor.option("opened")).toBe(true);
            POM.popup.recurrenceSettingsButton.click();
            expect(null === repeatEditor || void 0 === repeatEditor ? void 0 : repeatEditor.option("opened")).toBe(false)
        });
    ...
    describe("showAppointmentPopup", () => {
        ...
        it("should open appointment popup with correct data", async () => {
            ...
            scheduler.showAppointmentPopup(commonAppointment);
            expect(POM.popup.component.option("visible")).toBe(true);
            expect(POM.popup.dxForm.option("formData")).toMatchObject(Object.assign({}, commonAppointment))
        })
    });
...
describe("Appointment Popup", () => {
    ...
    it("should focus appointment after closing popup", async () => {
        ...
        jest.runAllTimers();
        expect(null === appointmentElement || void 0 === appointmentElement ? void 0 : appointmentElement.classList.contains("dx-state-focused")).toBe(true)
    });
    describe("Toolbar", () => {
        ...
        it.each([{
            ...
            const toolbarItems = POM.popup.component.option("toolbarItems") ?? [];
            expect(toolbarItems.some(i => "cancel" === i.shortcut)).toBe(true);
            expect(toolbarItems.some(i => "done" === i.shortcut)).toBe(shouldHaveSaveButton)
        });
        it.each([{
            allowUpdating: false,
            disabled: false
...
describe("Customize form items", () => {
    ...
    describe("Basic form customization", () => {
        ...
        it("should filter children when items array is specified", async () => {
            ...
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(1);
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items = mainGroup.items) || void 0 === _mainGroup$items ? void 0 : _mainGroup$items.length).toBe(1);
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items2 = mainGroup.items) || void 0 === _mainGroup$items2 || null === (_mainGroup$items2 = _mainGroup$items2[0]) || void 0 === _mainGroup$items2 ? void 0 : _mainGroup$items2.name).toBe("subjectGroup")
        });
    ...
    describe("Form customization with editing.items", () => {
        ...
        it("should handle object configuration with custom items", async () => {
            ...
            const formItems = form.option("items");
            const mainGroup = null === formItems || void 0 === formItems ? void 0 : formItems[0];
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items3 = mainGroup.items) || void 0 === _mainGroup$items3 ? void 0 : _mainGroup$items3.length).toBe(2);
            ...
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items5 = mainGroup.items) || void 0 === _mainGroup$items5 || null === (_mainGroup$items5 = _mainGroup$items5[1]) || void 0 === _mainGroup$items5 ? void 0 : _mainGroup$items5.name).toBe("dateGroup")
        });
        ...
        it("should handle empty items array in object config", async () => {
            ...
            const formItems = form.option("items");
            const mainGroup = null === formItems || void 0 === formItems ? void 0 : formItems[0];
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items6 = mainGroup.items) || void 0 === _mainGroup$items6 ? void 0 : _mainGroup$items6.length).toBe(0)
        })
    })
});
