...
describe("Appointments", () => {
    ...
    describe("onAppointmentRendered", () => {
        it("should be called with correct arguments when grid appointment is rendered", () => {
            ...
            expect(onAppointmentRendered).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it("should be called several times when several appointments are rendered", () => {
            ...
            expect(onAppointmentRendered).toHaveBeenNthCalledWith(1, expect.objectContaining({
                appointmentData: expect.objectContaining({
                    text: "Appointment 1"
                })
            }));
            expect(onAppointmentRendered).toHaveBeenNthCalledWith(2, expect.objectContaining({
                appointmentData: expect.objectContaining({
                    text: "Appointment 2"
                })
            }))
