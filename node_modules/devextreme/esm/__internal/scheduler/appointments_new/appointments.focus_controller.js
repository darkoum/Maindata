/**
 * DevExtreme (esm/__internal/scheduler/appointments_new/appointments.focus_controller.js)
 * Version: 25.2.7
...
export class AppointmentsFocusController {
    ...
    onViewItemFocusOut(e) {
        ...
        const isFocusOutside = 0 === $relatedTarget.length || 0 === $relatedTarget.closest($commonContainer).length && 0 === (null === $relatedTarget || void 0 === $relatedTarget ? void 0 : $relatedTarget.closest($allDayContainer ?? $()).length);
        if (isFocusOutside) {
    ...
    resetTabIndex(newFocusableIndex) {
        ...
        if (this.needRestoreFocusIndex >= 0) {
            ...
            focus.trigger(null === viewItem || void 0 === viewItem ? void 0 : viewItem.$element());
    ...
    scrollToItem(itemData) {
        ...
        const group = getRawAppointmentGroupValues(itemData.itemData, getResourceManager().resources);
        scrollTo(date, {
            group: group,
