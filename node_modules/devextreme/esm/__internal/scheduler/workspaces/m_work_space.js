...
class SchedulerWorkSpace extends Widget {
    ...
    getViewStartByOptions() {
        return getViewStartByOptions(this.option("startDate"), this.option("currentDate"), this.getTotalViewDuration(), this.option("startDate") ? this.calculateViewStartDate() : void 0)
    }
    ...
    getPanelDOMSize(panelName) {
        return "allDayPanel" === panelName ? this.cache.memo("allDayPanelSize", () => getBoundingRect(this._$allDayPanel.get(0))) : this.cache.memo("regularPanelSize", () => getBoundingRect(this.getDateTable().get(0)))
    }
    ...
    renderRDateTable() {
        utils.renovation.renderComponent(this, this._$dateTable, DateTableComponent, "renovatedDateTable", this.getRDateTableProps())
    }
    renderRGroupPanel() {
        var _this$option4;
        const options = {
        ...
        if (null !== (_this$option4 = this.option("groups")) && void 0 !== _this$option4 && _this$option4.length) {
            ...
            utils.renovation.renderComponent(this, this.getGroupHeaderContainer(), GroupPanelComponent, "renovatedGroupPanel", options)
        } else {
    ...
    renderRTimeTable() {
        utils.renovation.renderComponent(this, this.$timePanel, TimePanelComponent, "renovatedTimePanel", {
            viewContext: this.getR1ComponentsViewContext(),
    ...
    createAllDayPanelElements() {
        ...
        if (this.isVerticalGroupedWorkSpace() && 0 !== groupCount) {
            for (let i = 0; i < groupCount; i++) {
                ...
                this._$allDayPanel = $("<div>").addClass(ALL_DAY_PANEL_CLASS).append(this.$allDayTable);
                this.allDayPanels.push(this._$allDayPanel)
            }
        } else {
            this.$allDayTitle = $("<div>").addClass(ALL_DAY_TITLE_CLASS).text(messageLocalization.format("dxScheduler-allDay")).appendTo(this.$element());
            this.$allDayTable = $("<table>").attr("aria-hidden", true);
            this._$allDayPanel = $("<div>").addClass(ALL_DAY_PANEL_CLASS).append(this.$allDayTable)
        }
    }
    ...
    renderDateHeaderTemplate(container, panelCellIndex, templateIndex, cellTemplate, templateCallbacks) {
        ...
        const $cell = $("<th>").addClass(this.getHeaderPanelCellClass(panelCellIndex)).attr("title", text);
