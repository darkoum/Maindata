...
export const sortAppointments = (optionManager, items) => {
    const {
...
export const generateGridViewModel = (schedulerStore, optionManager, items) => {
    const {
    ...
    const step4 = filterByVirtualScreen(items, viewDataProvider, isVirtualScrolling);
