...
$chat-border-radius: $base-border-radius !default;
$chat-bubble-border-radius: $base-border-radius !default;
...
$chat-messagebox-files-container-padding: 3px !default;
$chat-messagebox-files-container-padding-top: 2px !default;
$chat-messagebox-file-container-padding: null !default;
$chat-messagebox-file-container-border-radius: 4px !default;
...
$chat-messagegroup-alignment-start-template: auto 82.5% 1fr !default;
...
$chat-message-editing-preview-caption-font-size: 12px !default;
...
$chat-message-editing-preview-border-width: 3px !default;
...
$chat-messagelist-day-header-font-size: 12px !default;
...
$chat-typingindicator-bubble-column-gap: 4px !default;
$chat-typingindicator-circle-size: null !default;
$chat-typingindicator-circle-size-center: null !default;
$chat-typingindicator-circle-border-radius: 999em !default;

$chat-confirmation-popup-content-padding: null !default;
$chat-confirmation-popup-toolbar-padding-block: $generic-popup-toolbarbottom-padding !default;
...
$chat-file-size-max-width: 4em !default;
$chat-file-icon-font-size: null !default;
...
@if $size == "default" {
  ...
  $chat-messagebox-file-container-padding: 5px 8px !default;
  $chat-messagelist-padding: 20px !default;
  $chat-messagegroup-padding: 24px !default;

  $chat-file-button-size: 36px !default;

  $chat-alerts-padding-block: 16px !default;
  $chat-alerts-row-gap: 4px !default;
  $chat-alert-padding-block: 9px !default;
  ...
  $chat-typingindicator-circle-size: math.div(8, 14) * 1em !default;
  $chat-typingindicator-circle-size-center: math.div(12, 14) * 1em !default;
  $chat-typingindicator-bubble-padding-block: 12px !default;
  $chat-typingindicator-bubble-padding-inline: 20px !default;
  ...
  $chat-file-icon-font-size: 18px !default;
}
...
@else if $size == "compact" {
  ...
  $chat-messagebox-file-container-padding: 2px 4px !default;
  $chat-messagelist-padding: 16px !default;
  $chat-messagegroup-padding: 12px !default;

  $chat-file-button-size: 26px !default;
  ...
  $chat-typingindicator-circle-size: math.div(8, 12) * 1em !default;
  $chat-typingindicator-circle-size-center: math.div(12, 12) * 1em !default;
  $chat-typingindicator-bubble-padding-block: 8px !default;
  $chat-typingindicator-bubble-padding-inline: 12px !default;
  $chat-typingindicator-padding: $chat-messagegroup-padding !default;
  ...
  $chat-file-icon-font-size: 14 !default;
}
