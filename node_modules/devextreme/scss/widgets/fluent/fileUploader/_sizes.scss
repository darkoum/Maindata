...
$fluent-fileuploader-file-container-padding: null !default;
$fluent-fileuploader-file-container-text-margin: null !default;
$fluent-fileuploader-file-container-button-margin: null !default;
$fluent-fileuploader-file-cancel-button-margin-left: 4px !default;
...
$fluent-fileuploader-file-icon-font-size: null !default;
...
@if $size == "default" {
  ...
  $fluent-fileuploader-file-size-margin: 0 0 0 4px !default;
  $fluent-fileuploader-file-icon-font-size: 20px !default;
}
...
@else if $size == "compact" {
  ...
  $fluent-fileuploader-files-container-padding: 12px 4px 0 !default;
  $fluent-fileuploader-file-size-margin: 0 0 4px !default;
  $fluent-fileuploader-file-icon-font-size: 16px !default;
}
