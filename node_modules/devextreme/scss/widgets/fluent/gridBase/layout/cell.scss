...
@mixin fluent-grid-base-cell($widget-name) {
  ...
  // (0,3,1)
  .dx-#{$widget-name}-rowsview .dx-row-removed.dx-row-lines > td {
  ...
  .dx-#{$widget-name}-rowsview .dx-row-removed:not(.dx-row-lines) > td {
    border-top: 1px solid;
    border-top-color: $datagrid-hover-bg;
  }

  // (0,3,1) - (0,4,2)
  .dx-#{$widget-name}-rowsview .dx-row-focused:not(.dx-row-lines) > td,
  .dx-#{$widget-name}-rowsview .dx-row-focused:not(.dx-row-lines) > tr:first-child > td {
    border-bottom: 1px solid;
  ...
  // (0,4,1)
  .dx-#{$widget-name} .dx-#{$widget-name}-table .dx-header-row > td:first-child {
    border-top-left-radius: $datagrid-border-radius;
  }

  // (0,4,1)
  .dx-#{$widget-name} .dx-#{$widget-name}-table .dx-header-row > td:last-child {
  ...
  // (0,3,1)
  .dx-#{$widget-name} .dx-#{$widget-name}-table .dx-#{$widget-name}-filter-row > td {
    padding-top: 0;
    padding-bottom: 0;
  }
  ...
  // (0,7,1) - (0,9,1)
  .dx-#{$widget-name} .dx-#{$widget-name}-content .dx-#{$widget-name}-table .dx-row > td:not(.dx-validation-pending):not(.dx-#{$widget-name}-select-all).dx-command-expand,
  .dx-#{$widget-name} .dx-#{$widget-name}-content .dx-#{$widget-name}-table .dx-row > td:not(.dx-validation-pending):not(.dx-#{$widget-name}-select-all) .dx-#{$widget-name}-group-space,
  .dx-#{$widget-name} .dx-#{$widget-name}-content .dx-#{$widget-name}-table .dx-row > td.dx-cell-modified:not(.dx-field-item-content):not(.dx-validation-pending).dx-command-expand,
  .dx-#{$widget-name} .dx-#{$widget-name}-content .dx-#{$widget-name}-table .dx-row > td.dx-cell-modified:not(.dx-field-item-content):not(.dx-validation-pending) .dx-#{$widget-name}-group-space,
  .dx-#{$widget-name} .dx-#{$widget-name}-content .dx-#{$widget-name}-table .dx-row > td.dx-#{$widget-name}-invalid:not(.dx-field-item-content):not(.dx-validation-pending):not(.dx-#{$widget-name}-select-all).dx-command-expand,
  .dx-#{$widget-name} .dx-#{$widget-name}-content .dx-#{$widget-name}-table .dx-row > td.dx-#{$widget-name}-invalid:not(.dx-field-item-content):not(.dx-validation-pending):not(.dx-#{$widget-name}-select-all) .dx-#{$widget-name}-group-space {
    padding: 0 4px 0 8px;
  }
  ...
  // (0,4,0) - (0,6,0)
  .dx-#{$widget-name}-rowsview .dx-data-row:not(.dx-edit-row) .dx-cell-modified,
  .dx-#{$widget-name}-rowsview .dx-adaptive-detail-row:not(.dx-edit-row) .dx-cell-modified,
  .dx-#{$widget-name}-rowsview .dx-data-row.dx-selection:not(.dx-edit-row) .dx-cell-modified,
  .dx-#{$widget-name}-rowsview .dx-adaptive-detail-row.dx-selection:not(.dx-edit-row) .dx-cell-modified,
  .dx-#{$widget-name}-rowsview .dx-data-row.dx-selection:hover:not(.dx-edit-row) .dx-cell-modified,
  .dx-#{$widget-name}-rowsview .dx-adaptive-detail-row.dx-selection:hover:not(.dx-edit-row) .dx-cell-modified {
