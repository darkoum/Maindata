...
* $type text
*/
$datagrid-border-radius: 0 !default;
...
$fluent-grid-base-cell-font-size: null !default;
$fluent-grid-base-checkbox-size: null !default;
$fluent-grid-base-cell-horizontal-padding: null !default;
$fluent-grid-base-texteditor-input-padding: null !default;
...
$fluent-grid-base-treeview-select-all-item-offset: null !default;

$fluent-grid-base-header-line-height: 18px !default;
$fluent-grid-base-header-icon-size: null !default;
$fluent-grid-base-header-icon-container-size: 20px !default;
$fluent-grid-base-column-chooser-item-margin: 8px !default;
$fluent-command-edit-icon-margin: 4px !default;
$fluent-command-edit-text-margin: 2px !default;

$fluent-command-edit-icon-size: null !default;
$fluent-filter-panel-icon-size: null !default;

$fluent-grid-base-filter-icon-size: $fluent-button-icon-size !default;
$fluent-grid-base-command-ai-chatsparkleoutline-icon-size: null !default;
$fluent-grid-base-command-ai-text-content-padding: null !default;
$fluent-grid-base-command-ai-header-button-offset: null !default;
$fluent-grid-base-ai-prompt-editor-progressbar-height: 4px !default;
...
@if $size == "default" {
  ...
  $fluent-grid-base-checkbox-size: 18px !default;
  $fluent-grid-base-cell-horizontal-padding: 16px !default;

  $fluent-grid-base-texteditor-input-padding: 40px !default;
  ...
  $fluent-grid-base-treeview-select-all-item-offset: 34px !default;
  ...
  $fluent-grid-base-command-ai-chatsparkleoutline-icon-size: 20px !default;
  $fluent-grid-base-command-ai-text-content-padding: $fluent-grid-base-command-ai-chatsparkleoutline-icon-size + 8px !default;
...
@else if $size == "compact" {
  ...
  $fluent-grid-base-texteditor-input-padding: 36px !default;
  ...
  $fluent-grid-base-treeview-select-all-item-offset: 28px !default;

  $fluent-grid-base-header-icon-size: 16px !default;
  $fluent-command-edit-icon-size: 16px !default;
  $fluent-filter-panel-icon-size: 16px !default;
  $fluent-grid-base-command-ai-chatsparkleoutline-icon-size: 16px !default;
  $fluent-grid-base-command-ai-text-content-padding: $fluent-grid-base-command-ai-chatsparkleoutline-icon-size + 6px !default;
  $fluent-grid-base-command-ai-header-button-offset: 6px !default;
}
