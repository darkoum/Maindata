...
declare class ModalDirective implements OnDestroy, OnInit {
    ...
    configInput: i0.InputSignal<ModalOptions<Record<string, unknown>> | undefined>;
    /** allows to provide a callback to intercept the closure of the modal */
    closeInterceptor: i0.InputSignal<CloseInterceptorFn | undefined>;
    /** This event fires immediately when the `show` instance method is called. */
    onShow: i0.OutputEmitterRef<ModalDirective>;
    /** This event is fired when the modal has been made visible to the user
     * (will wait for CSS transitions to complete)
     */
    onShown: i0.OutputEmitterRef<ModalDirective>;
    /** This event is fired immediately when
     * the hide instance method has been called.
     */
    onHide: i0.OutputEmitterRef<ModalDirective>;
    /** This event is fired when the modal has finished being
     * hidden from the user (will wait for CSS transitions to complete).
     */
    onHidden: i0.OutputEmitterRef<ModalDirective>;
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<ModalDirective, "[bsModal]", ["bs-modal"], { "configInput": { "alias": "config"; "required": false; "isSignal": true; }; "closeInterceptor": { "alias": "closeInterceptor"; "required": false; "isSignal": true; }; }, { "onShow": "onShow"; "onShown": "onShown"; "onHide": "onHide"; "onHidden": "onHidden"; }, never, never, true, never>;
}
