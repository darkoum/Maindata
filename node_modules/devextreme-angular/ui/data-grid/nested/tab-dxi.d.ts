...
export declare class DxiDataGridTabComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    private renderer;
    private document;
    private element;
...
export declare class DxiDataGridTabModule {
