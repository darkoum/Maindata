...
export declare class DxiDataGridTabPanelOptionsItemComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    private renderer;
    private document;
    private element;
    get badge(): string;
...
export declare class DxiDataGridTabPanelOptionsItemModule {
