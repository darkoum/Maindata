...
export declare class DxiDataGridDataGridToolbarItemComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    private renderer;
    private document;
    private element;
...
export declare class DxiDataGridDataGridToolbarItemModule {
